...
<?php include 'header.php';?>
          ...
          $postid =  htmlspecialchars($_GET["postid"]);
            $fulldescription = mysqli_query($conn,"select id,title,shortdesc,description,filepath from posts where active = 'Y' and id = '$postid' order by id desc");
			
			
			 $fulldescriptioneditor = mysqli_query($conn,"select id,title,shortdesc,description,filepath from posts where active = 'Y' and id = '$postid' order by id desc");
