...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            $registrationlicenceList = mysqli_query($conn,"select id,title,shortdesc,description,filepath,categoryname from posts where active = 'Y' order by id desc");
       ?>
            ...
            ?>
                                        <tr>
                                            ...
                                            <td><a class="text-decoration-none"
                                                    href="registrationlicenseslist.php?update=<?php echo $row["id"]; ?>"><i
                                                        class="fa fa-edit"></i> </a> ||
                                                <a class="text-decoration-none"
                                                    href="registrationlicenseslist.php?registrationdel=<?php echo $row["id"]; ?>"><i
                                                        class="fa fa-trash"></i></a> ||
                                                <a class="text-decoration-none"
                                                    href="registrationlicenseslist.php?uploadimage=<?php echo $row["id"]; ?>"><i
        ...
        <?php 
          ...
          $update =  htmlspecialchars($_GET["update"]);
            ...
            $updateregistrationlicenceList = mysqli_query($conn,"select id,title,shortdesc,description,filepath from posts where active = 'Y' and id = '$update' order by id desc");
                        ...
                        <div class="card shadow mb-4 rounded-0">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div><a href="registrationlicenseslist.php" class="btn btn-success rounded-0">View
                                            List</a></div>
                                </div>
	...
	<?php
                $i=0;
                $count = 1;
                while($rows = mysqli_fetch_array($categoryList)) {
            ?>
	...
	<?php
			  ...
			  ?>
                                    ...
                                    <input type="submit" class="btn btn-primary rounded-0"
                                        name="updateregistrationandlicence" value="Submit">
	...
	<div class="row displayphotoupload d-none">
          ...
          $uploadimage =  htmlspecialchars($_GET["uploadimage"]);
            $imageregistrationlicenceList = mysqli_query($conn,"select id,title,shortdesc,description,filepath from posts where active = 'Y' and id = '$uploadimage' order by id desc");
       ?>
    ...
    <div class="card-body">
            ...
            ?>
                                ...
                                <form action="querycontrol.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="submit" class="btn btn-primary rounded-0"
                                        name="uploadimageregistrationandlicence" value="Submit">
